...
> AI 编程助手的 PowerShell 安全规则 — 文件编码陷阱、BOM 处理、引号规范、破坏性命令防护。
...
| 技能 | 用途 |
|------|------|
| `powershell-safety` | 文件编码铁律、BOM 处理、引号规范、原生 exe 管道、破坏性命令安全 |
...
- 域名技能在任务的 `Use when` 描述匹配时自动激活
- `encoding-guide.md` 参考文档在写源文件或调试乱码时加载
